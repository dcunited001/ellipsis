      ...
      authorizedKeys =
        ...
        [
          (builtins.fetchurl {
            ...
            sha256 = "2787b56a1a8682853819fdd457773247040d3893ec8f255bd71093281cabf533";
          })
          (builtins.fetchurl {
            url = "${r}/${c}/${p}/berlin.guix.gnu.org.pub";
            sha256 = "0f7e51614eac75353196b650e73b7b5eeee59824b0f78935da0d6717ddd1792f";
          })
          (builtins.fetchurl {
            url = "${r}/${c}/${p}/substitutes.nonguix.org.pub";
            sha256 = "e784a3187cada58ac33c98cb0a7c3dc5ce253509fe0a8c6c717dedbe02b6c648";
          })
        ];
    };
