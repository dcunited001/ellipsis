...
;; TODO: eventually may need to map the transformation across the list/graph,
;; but flatpak pulls in gnupg ... so use (package-input-rewriting/spec ...)

;; this returns a procedure
(define transform-gnupg
  (options->transformation
   '((with-graft . "gnupg=gnupg2.3"))))
