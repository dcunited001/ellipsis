...
set $lockpaper /data/xdg/Pictures/wallpapers/anime/blood-blockade-leonardo-2a.jpg
exec --no-startup-id xss-lock --transfer-sleep-lock -- i3lock --nofork -e -i $lockpaper

# TODO: fix reference to path
...
This will likely be moved to its own manifest.
...
**** TODO explore texlive ecosystem :latex:
+ Main Guix texlive package entrypoint
  - [[file:/data/ecto/guix/guix/gnu/packages/tex.scm::(define-public texlive-bin][guix/gnu/packages/tex.scm]]
