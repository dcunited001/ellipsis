...
For the purposes of proving the how of why we cannot have nice things -- and
to briefly review -- here's the chain of potential key conflicts:

#+begin_src mermaid :file img/byobu-key-conflicts.svg
WM --> XTermAppX --> Byobu --> GNUScreen --> Emacs
Vty --> Console --> GNUScreen
#+end_src
