(custom-set-variables
 ...
 '(package-selected-packages
   '(0x0 a ace-window cape consult consult-dir corfu corfu-terminal
		 ef-themes embark embark-consult json-mode lispy magit
		 marginalia markdown-mode multiple-cursors nix-mode
		 no-littering orderless toml-mode vertico x509-mode xkb-mode
		 xkb-mode yuck-mode))
   ...
   '((eval let
		   ...
		   (when root-dir-unexpanded
			 (let*
				  ...
				  (guix-pr
				   (or (and (bound-and-true-p guix-pulled-profile))
					   (expand-file-name ".config/guix/current"
										 (getenv "HOME"))))
				  (guix-lp
				   (expand-file-name "share/guile/site/3.0" guix-pr))
				  (guix-lcp
				   (expand-file-name "lib/guile/3.0/site-ccache"
									 guix-pr)))
			   ...
			   (cl-dolist
				   (pathdir
					(list guix-lp guix-lcp ellipsis-dir dc-dir))
