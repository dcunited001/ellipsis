...
hl.workspace_rule({ workspace = "9", monitor = "desc:" .. dc.m1.desc, layout_opts = { orientation = "center", mfact = 0.4, } })
...
hl.workspace_rule({ workspace = "10", monitor = "desc:" .. dc.m2.desc, layout_opts = { orientation = "center", mfact = 0.4, } })
