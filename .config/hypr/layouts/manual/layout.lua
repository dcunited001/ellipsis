dc = dc or {}
dc.lo = (dc.lo or {})
dc.lo.manual = (dc.lo.manual or {})

-- TODO: set the layout state for current workspace. see bin/omarch-hyprland-workspace-layout-toggle:
--
-- https://github.com/basecamp/omarchy/blob/83881e979b35468c3e7d60b171e319ede61a88fd/bin/omarchy-hyprland-workspace-layout-toggle#L2
--
-- or https://wiki.hypr.land/configuring/code-snippets/
--
-- doesn't support window swapping or drag/drop features (maybe could? idk)
--
-- saving the layout resets the state (work in a copy)
