...
GUIX_AUTOLOAD_PROFILES=(desktop i3 devtools)
...
#+begin_src scheme :noweb-ref "tui-env-manifest" :noweb-sep ""
...
#+begin_src scheme :noweb-ref "tui-apps-manifest" :noweb-sep ""
...
#+begin_src scheme :tangle .config/guix/manifests/tui-env.scm :noweb yes
(specifications->manifest
 '(
   <<tui-env-manifest>>
   ))
...
#+begin_src scheme :tangle .config/guix/manifests/tui-apps.scm :noweb yes
(specifications->manifest
 '(
   <<tui-apps-manifest>>
   ))
