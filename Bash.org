...
The dependencies are in a manifest

#+begin_src scheme :tangle .config/guix/manifests/julia-pluto.scm
...
Pluto can be defined as a shepherd service

+ requires the manifest and guix-bioinformatics channel

#+begin_src scheme :tangle .config/shepherd/julia-pluto.scm
...
Then start pluto from a separate Shepherd process
...
then
    PS1='\[\033[1;33m\]\A'' \[\033[1;32m\]''\u''\[\033[31m\]''@''\[\033[1;36m\]''\h \[\033[31m\]::''\[\033[1;33m\] \w''\[\033[31m\] [env] :: \[\033[00m\]'
else
