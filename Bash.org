...
export GUILE_LOAD_PATH=$GUIX_EXTRA/emacs-native-comp/emacs-native-comp/share/guile/site/3.0:$GUILE_LOAD_PATH
export GUILE_LOAD_COMPILED_PATH=$GUIX_EXTRA/emacs-native-comp/emacs-native-comp/lib/guile/3.0/site-ccache:$GUIX_EXTRA/emacs-native-comp/emacs-native-comp/share/guile/site/3.0:$GUILE_LOAD_COMPILED_PATH
#+end_src
...
GUIX_AUTOLOAD_PROFILES=(arch-pwsafe academic emacs-native-comp)
...
***** On Arch
****** TODO package to build blender module (or guix package?)
***** On Guix
