...
***** TODO ... fix XDG path references in bash scripts ([[https://unix.stackexchange.com/questions/57658/how-to-utilize-xdg-directories-and-paths-in-bash][stackexchange]])
...
# TODO: source $HOME/.config/sh/rc.d files here
#+end_src
