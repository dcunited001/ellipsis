...
export VISUAL="gmacsclient"
export EDITOR="gmacsclient -- -nw"
...
GUIX_AUTOLOAD_PROFILES=(arch-pwsafe academic arch-devtools)
...
#+begin_quote
Note, this still isn't copying to clipboard (I swear it was working)
#+end_quote

Run =bind -f $file= to emit bindings to a script.
...
#+begin_src sh :tangle .config/sh/rc.d/aliases.sh :shebang #!/bin/sh
#* window-mgmt @ALIAS
alias @terminator='terminator "\$${__title:-TERM}"'
#+end_src
...
#+begin_src sh :tangle .config/sh/rc.d/functions.sh :shebang #!/bin/sh
