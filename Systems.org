...
(setq dw/system-settings
  (map-merge
    ...
    '((desktop/dpi . 180)
      ...
      ;; TODO: refactor this
      (dunst/icon-path . "/home/dc/.guix-extra-profiles/desktop/desktop/share/icons/gnome/256x256/status/:/home/dc/.guix-extra-profiles/desktop/desktop/share/icons/gnome/256x256/devices/:/home/dc/.guix-extra-profiles/desktop/desktop/share/icons/gnome/256x256/emblems/")
...
#+begin_src emacs-lisp :noweb-ref system-settings :noweb-sep ""
  ...
  (when (equal system-name "kratos")
    '((desktop/dpi . 221) ;; TODO verify DPI
      (emacs/default-face-size . 190)
      (emacs/variable-face-size . 200)
      (emacs/fixed-face-size . 190)
      ...
      ;; TODO: refactor
      (dunst/icon-path "/usr/share/icons/Adwaita/16x16/status/:/usr/share/icons/Adwaita/16x16/devices/")
      ;(vimb/default-zoom . 160)
      ;(qutebrowser/default-zoom . 180)
      ))
