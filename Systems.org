...
__substitute_urls=${__GUIX_SUBSTITUTE_URLS:-https://ci.guix.gnu.org https://bordeaux.guix.gnu.org}
...
for profile in $profiles; do
  ...
  if [ -f $manifestPath ]; then
    ...
    mkdir -p $profilePath
    guix package --manifest=$manifestPath --profile="$profilePath/$profileName" --substitute-urls="$__substitute_urls"
